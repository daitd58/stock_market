...
$stock_market_wp_frontpage_content = stock_market_wp_get_option('stock_market_wp_frontpage_content'); 
...
<?php if($stock_market_wp_frontpage_content == 'Y' && get_option('show_on_front') == 'page') {  ?>
<?php if($stock_market_wp_prev_bg == 'bg-white') $stock_market_wp_curr_bg = 'bg-grey-light-2'; else $stock_market_wp_curr_bg = 'bg-white';  
$stock_market_wp_prev_bg = $stock_market_wp_curr_bg; ?>
<!-- ========== Page Content ========== -->
<div class="section frontpage-content <?php echo esc_attr($stock_market_wp_curr_bg) ?>" id="welcome">
    <div class="container">
...
<div class="section frontpage-content bg-white" id="welcome">
    <div class="container">
        <?php stock_market_wp_example_frontpage_content(); ?>
    </div>
</div> 
<!-- ========== /Random Page Content ========== -->
<?php } ?>