...
<div class="section post-content bg-white">
    <div class="container">
        <div class="row">
            ...
            <?php 
            $stock_market_wp_post_sidebar = stock_market_wp_get_option('stock_market_wp_post_sidebar'); 
            if($stock_market_wp_post_sidebar == 'Y') { $col1_class = 'col-md-9'; $col2_class='col-md-3'; }
            ...
            <div class="<?php echo $col1_class ?>">
                ...
                <div id="post-<?php the_ID(); ?>" <?php post_class('clearfix'); ?>>
                    ...
                    <?php if($title == '') { ?>
                    <h3 class="entry-title"><?php echo _e('Post ID: ', 'stock_market'); echo get_the_ID(); ?></h3>
                    <?php } else { ?>
                    ...
                    <div class="entry-meta">
                        <?php if($stock_market_wp_post_meta_date == 'Y') { $temp[] = __('Posted: ', 'stock_market') . get_the_date(); } ?>
                        <?php if($stock_market_wp_post_meta_category == 'Y') { $temp[] = __('Under: ', 'stock_market'). get_the_category_list(', '); } ?>
                        <?php if($stock_market_wp_post_meta_author == 'Y') { $temp[] = __('By: ', 'stock_market')  . get_the_author();  } ?>
            ...
            <?php if($stock_market_wp_post_sidebar == 'Y') { ?>
            <!-- Sidebar -->
