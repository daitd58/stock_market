...
(function ($) {
    $(document).ready(function () {
        $.getJSON('http://localhost/wordpress/wp-content/themes/stock_market/jsonp.php?filename=data.json&callback=?', function (data) {
            var first = data[0];
        ...
        $.getJSON('http://localhost/wordpress/wp-content/themes/stock_market/jsonp.php?filename=data_compare.json&callback=?', function (data) {
            var data1 = [];
            var data2 = [];
